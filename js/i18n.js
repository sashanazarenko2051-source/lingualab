...
App.I18N = {
  ru: {
    ...
    bgp_jungle: 'Джунгли',
    bgp_waterfall: 'Водопад',
    bgp_cave: 'Пещера',
    bgp_candy: 'Конфеты',
    bgp_galaxy: 'Галактика',
    bgp_coral: 'Риф',
    bgp_autumn: 'Осень',
    bgp_spring: 'Весна',
    bgp_neon: 'Неон',
    ...
    bgp_blossom: 'Сакура',
    bgp_bamboo: 'Бамбук',
    bgp_icecave: 'Ледяная пещера',
    bgp_campfire: 'Костёр',
    bgp_underwater: 'Подводный мир',
    bgp_tropical: 'Тропики',
    bgp_checker: 'Шахматка',
    bgp_stripes: 'Полоски'
  },
  ...
  en: {
    ...
    bgp_jungle: 'Jungle',
    bgp_waterfall: 'Waterfall',
    bgp_cave: 'Cave',
    bgp_candy: 'Candy',
    bgp_galaxy: 'Galaxy',
    bgp_coral: 'Coral Reef',
    bgp_autumn: 'Autumn',
    bgp_spring: 'Spring',
    bgp_neon: 'Neon',
    bgp_beach: 'Beach',
    ...
    bgp_blossom: 'Blossom',
    bgp_bamboo: 'Bamboo',
    bgp_icecave: 'Ice Cave',
    bgp_campfire: 'Campfire',
    bgp_underwater: 'Underwater',
    bgp_tropical: 'Tropical',
    bgp_checker: 'Checkerboard',
    bgp_stripes: 'Stripes'
  },
  ...
  de: {
    ...
    bgp_jungle: 'Dschungel',
    bgp_waterfall: 'Wasserfall',
    bgp_cave: 'Höhle',
    bgp_candy: 'Süßigkeiten',
    bgp_galaxy: 'Galaxie',
    bgp_coral: 'Korallenriff',
    bgp_autumn: 'Herbst',
    bgp_spring: 'Frühling',
    bgp_neon: 'Neon',
    bgp_beach: 'Strand',
    ...
    bgp_blossom: 'Blüte',
    bgp_bamboo: 'Bambus',
    bgp_icecave: 'Eishöhle',
    bgp_campfire: 'Lagerfeuer',
    bgp_underwater: 'Unterwasser',
    bgp_tropical: 'Tropisch',
    bgp_checker: 'Schachbrett',
    bgp_stripes: 'Streifen'
  },
  ...
  nl: {
    ...
    bgp_bamboo: 'Bamboe',
    bgp_icecave: 'IJsgrot',
    bgp_campfire: 'Kampvuur',
    bgp_underwater: 'Onderwater',
    bgp_tropical: 'Tropisch',
    bgp_checker: 'Schaakbord',
    bgp_stripes: 'Strepen'
  },
  ...
  sv: {
    ...
    bgp_bamboo: 'Bambu',
    bgp_icecave: 'Ishåla',
    bgp_campfire: 'Lägereld',
    bgp_underwater: 'Undervattens',
    bgp_tropical: 'Tropisk',
    bgp_checker: 'Schackbräde',
    bgp_stripes: 'Ränder'
  },
  ...
  no: {
    ...
    bgp_bamboo: 'Bambus',
    bgp_icecave: 'Ishule',
    bgp_campfire: 'Leirbål',
    bgp_underwater: 'Undervanns',
    bgp_tropical: 'Tropisk',
    bgp_checker: 'Sjakkbrett',
    bgp_stripes: 'Striper'
  },
  ...
  da: {
    ...
    bgp_bamboo: 'Bambus',
    bgp_icecave: 'Ishule',
    bgp_campfire: 'Lejrbål',
    bgp_underwater: 'Undervands',
    bgp_tropical: 'Tropisk',
    bgp_checker: 'Skakbræt',
    bgp_stripes: 'Striber'
  },
  ...
  fr: {
    ...
    bgp_jungle: 'Jungle',
    bgp_waterfall: 'Cascade',
    bgp_cave: 'Grotte',
    bgp_candy: 'Bonbons',
    bgp_galaxy: 'Galaxie',
    bgp_coral: 'Récif corallien',
    bgp_autumn: 'Automne',
    bgp_spring: 'Printemps',
    bgp_neon: 'Néon',
    bgp_beach: 'Plage',
    bgp_rain: 'Pluie',
    bgp_storm: 'Orage',
    bgp_blossom: 'Fleurs',
    bgp_bamboo: 'Bambou',
    bgp_icecave: 'Grotte de glace',
    bgp_campfire: 'Feu de camp',
    bgp_underwater: 'Sous-marin',
    bgp_tropical: 'Tropical',
    bgp_checker: 'Damier',
    bgp_stripes: 'Rayures'
  },
  ...
  es: {
    ...
    bgp_jungle: 'Selva',
    bgp_waterfall: 'Cascada',
    bgp_cave: 'Cueva',
    bgp_candy: 'Caramelos',
    bgp_galaxy: 'Galaxia',
    bgp_coral: 'Arrecife',
    bgp_autumn: 'Otoño',
    bgp_spring: 'Primavera',
    bgp_neon: 'Neón',
    bgp_beach: 'Playa',
    bgp_rain: 'Lluvia',
    bgp_storm: 'Tormenta',
    bgp_blossom: 'Flores',
    bgp_bamboo: 'Bambú',
    bgp_icecave: 'Cueva de hielo',
    bgp_campfire: 'Fogata',
    bgp_underwater: 'Submarino',
    bgp_tropical: 'Tropical',
    bgp_checker: 'Tablero',
    bgp_stripes: 'Rayas'
  },
  ...
  it: {
    ...
    bgp_jungle: 'Giungla',
    bgp_waterfall: 'Cascata',
    bgp_cave: 'Grotta',
    bgp_candy: 'Caramelle',
    bgp_galaxy: 'Galassia',
    bgp_coral: 'Barriera corallina',
    bgp_autumn: 'Autunno',
    bgp_spring: 'Primavera',
    bgp_neon: 'Neon',
    bgp_beach: 'Spiaggia',
    ...
    bgp_blossom: 'Fiori',
    bgp_bamboo: 'Bambù',
    bgp_icecave: 'Grotta di ghiaccio',
    bgp_campfire: 'Falò',
    bgp_underwater: 'Sottomarino',
    bgp_tropical: 'Tropicale',
    bgp_checker: 'Scacchiera',
    bgp_stripes: 'Righe'
  },
  ...
  pt: {
    ...
    bgp_candy: 'Doces',
    bgp_galaxy: 'Galáxia',
    bgp_coral: 'Recife de coral',
    bgp_autumn: 'Outono',
    bgp_spring: 'Primavera',
    bgp_neon: 'Néon',
    bgp_beach: 'Praia',
    bgp_rain: 'Chuva',
    bgp_storm: 'Tempestade',
    bgp_blossom: 'Flores',
    bgp_bamboo: 'Bambu',
    bgp_icecave: 'Caverna de gelo',
    bgp_campfire: 'Fogueira',
    bgp_underwater: 'Subaquático',
    bgp_tropical: 'Tropical',
    bgp_checker: 'Tabuleiro',
    bgp_stripes: 'Riscas'
  },
  ...
  ro: {
    ...
    bgp_jungle: 'Junglă',
    bgp_waterfall: 'Cascadă',
    bgp_cave: 'Peșteră',
    bgp_candy: 'Dulciuri',
    bgp_galaxy: 'Galaxie',
    bgp_coral: 'Recif de corali',
    bgp_autumn: 'Toamnă',
    bgp_spring: 'Primăvară',
    bgp_neon: 'Neon',
    bgp_beach: 'Plajă',
    bgp_rain: 'Ploaie',
    bgp_storm: 'Furtună',
    bgp_blossom: 'Flori',
    bgp_bamboo: 'Bambus',
    bgp_icecave: 'Peșteră de gheață',
    bgp_campfire: 'Foc de tabără',
    bgp_underwater: 'Subacvatic',
    bgp_tropical: 'Tropical',
    bgp_checker: 'Tablă de șah',
    bgp_stripes: 'Dungi'
  },
  ...
  hr: {
    ...
    bgp_jungle: 'Džungla',
    bgp_waterfall: 'Vodopad',
    bgp_cave: 'Špilja',
    bgp_candy: 'Slatkiši',
    bgp_galaxy: 'Galaksija',
    bgp_coral: 'Koraljni greben',
    bgp_autumn: 'Jesen',
    bgp_spring: 'Proljeće',
    bgp_neon: 'Neon',
    bgp_beach: 'Plaža',
    bgp_rain: 'Kiša',
    bgp_storm: 'Oluja',
    bgp_blossom: 'Cvjetovi',
    bgp_bamboo: 'Bambus',
    bgp_icecave: 'Ledena špilja',
    bgp_campfire: 'Logorska vatra',
    bgp_underwater: 'Podvodni svijet',
    bgp_tropical: 'Tropski',
    bgp_checker: 'Šahovnica',
    bgp_stripes: 'Pruge'
  },
  ...
  sr: {
    ...
    bgp_cave: 'Пећина',
    bgp_candy: 'Слаткиши',
    bgp_galaxy: 'Галаксија',
    bgp_coral: 'Корални гребен',
    bgp_autumn: 'Јесен',
    bgp_spring: 'Пролеће',
    bgp_neon: 'Неон',
    bgp_beach: 'Плажа',
    ...
    bgp_blossom: 'Цветови',
    bgp_bamboo: 'Бамбус',
    bgp_icecave: 'Ледена пећина',
    bgp_campfire: 'Логорска ватра',
    bgp_underwater: 'Подводни свет',
    bgp_tropical: 'Тропски',
    bgp_checker: 'Шаховница',
    bgp_stripes: 'Пруге'
  },
  ...
  el: {
    ...
    bgp_jungle: 'Ζούγκλα',
    bgp_waterfall: 'Καταρράκτης',
    bgp_cave: 'Σπηλιά',
    bgp_candy: 'Καραμέλες',
    bgp_galaxy: 'Γαλαξίας',
    bgp_coral: 'Κοραλλιογενής ύφαλος',
    bgp_autumn: 'Φθινόπωρο',
    bgp_spring: 'Άνοιξη',
    bgp_neon: 'Νέον',
    bgp_beach: 'Παραλία',
    bgp_rain: 'Βροχή',
    ...
    bgp_blossom: 'Άνθη',
    bgp_bamboo: 'Μπαμπού',
    bgp_icecave: 'Παγοσπηλιά',
    bgp_campfire: 'Φωτιά κάμπινγκ',
    bgp_underwater: 'Υποβρύχιο',
    bgp_tropical: 'Τροπικό',
    bgp_checker: 'Σκάκι',
    bgp_stripes: 'Ρίγες'
  },
    ...
    bgp_jungle: 'Viidakko',
    bgp_waterfall: 'Vesiputous',
    bgp_cave: 'Luola',
    bgp_candy: 'Karkit',
    bgp_galaxy: 'Galaksi',
    bgp_coral: 'Koralliriutta',
    bgp_autumn: 'Syksy',
    bgp_spring: 'Kevät',
    bgp_neon: 'Neon',
    bgp_beach: 'Ranta',
    ...
    bgp_blossom: 'Kukinta',
    bgp_bamboo: 'Bambu',
    bgp_icecave: 'Jääluola',
    bgp_campfire: 'Nuotio',
    bgp_underwater: 'Vedenalainen',
    bgp_tropical: 'Trooppinen',
    bgp_checker: 'Shakkilauta',
    bgp_stripes: 'Raidat'
  },
  ...
  hu: {
    ...
    bgp_jungle: 'Dzsungel',
    bgp_waterfall: 'Vízesés',
    bgp_cave: 'Barlang',
    bgp_candy: 'Cukorka',
    bgp_galaxy: 'Galaxis',
    bgp_coral: 'Korallzátony',
    bgp_autumn: 'Ősz',
    bgp_spring: 'Tavasz',
    bgp_neon: 'Neon',
    bgp_beach: 'Strand',
    bgp_rain: 'Eső',
    bgp_storm: 'Vihar',
    bgp_blossom: 'Virágzás',
    bgp_bamboo: 'Bambusz',
    bgp_icecave: 'Jégbarlang',
    bgp_campfire: 'Tábortűz',
    bgp_underwater: 'Víz alatti',
    bgp_tropical: 'Trópusi',
    bgp_checker: 'Sakktábla',
    bgp_stripes: 'Csíkok'
  },
  ...
  pl: {
    ...
    bgp_jungle: 'Dżungla',
    bgp_waterfall: 'Wodospad',
    bgp_cave: 'Jaskinia',
    bgp_candy: 'Cukierki',
    bgp_galaxy: 'Galaktyka',
    bgp_coral: 'Rafa koralowa',
    bgp_autumn: 'Jesień',
    bgp_spring: 'Wiosna',
    bgp_neon: 'Neon',
    bgp_beach: 'Plaża',
    ...
    bgp_blossom: 'Kwiaty',
    bgp_bamboo: 'Bambus',
    bgp_icecave: 'Lodowa jaskinia',
    bgp_campfire: 'Ognisko',
    bgp_underwater: 'Podwodny świat',
    bgp_tropical: 'Tropikalny',
    bgp_checker: 'Szachownica',
    bgp_stripes: 'Paski'
  },
  ...
  cs: {
    ...
    bgp_jungle: 'Džungle',
    bgp_waterfall: 'Vodopád',
    bgp_cave: 'Jeskyně',
    bgp_candy: 'Bonbóny',
    bgp_galaxy: 'Galaxie',
    bgp_coral: 'Korálový útes',
    bgp_autumn: 'Podzim',
    bgp_spring: 'Jaro',
    bgp_neon: 'Neon',
    bgp_beach: 'Pláž',
    ...
    bgp_blossom: 'Květy',
    bgp_bamboo: 'Bambus',
    bgp_icecave: 'Ledová jeskyně',
    bgp_campfire: 'Táborák',
    bgp_underwater: 'Podvodní svět',
    bgp_tropical: 'Tropický',
    bgp_checker: 'Šachovnice',
    bgp_stripes: 'Pruhy'
  },
  ...
  sk: {
    ...
    bgp_blossom: 'Kvety',
    bgp_bamboo: 'Bambus',
    bgp_icecave: 'Ľadová jaskyňa',
    bgp_campfire: 'Táborák',
    bgp_underwater: 'Podvodný svet',
    bgp_tropical: 'Tropický',
    bgp_checker: 'Šachovnica',
    bgp_stripes: 'Pruhy'
  },
  ...
  uk: {
    ...
    bgp_jungle: 'Джунглі',
    bgp_waterfall: 'Водоспад',
    bgp_cave: 'Печера',
    bgp_candy: 'Цукерки',
    bgp_galaxy: 'Галактика',
    bgp_coral: 'Кораловий риф',
    bgp_autumn: 'Осінь',
    bgp_spring: 'Весна',
    bgp_neon: 'Неон',
    bgp_beach: 'Пляж',
    bgp_rain: 'Дощ',
    bgp_storm: 'Гроза',
    bgp_blossom: 'Цвітіння',
    bgp_bamboo: 'Бамбук',
    bgp_icecave: 'Крижана печера',
    bgp_campfire: 'Багаття',
    bgp_underwater: 'Підводний світ',
    bgp_tropical: 'Тропіки',
    bgp_checker: 'Шахівниця',
    bgp_stripes: 'Смуги'
  },
  ...
  bg: {
    ...
    bgp_blossom: 'Цъфтеж',
    bgp_bamboo: 'Бамбук',
    bgp_icecave: 'Ледена пещера',
    bgp_campfire: 'Огън',
    bgp_underwater: 'Подводен свят',
    bgp_tropical: 'Тропически',
    bgp_checker: 'Шахматна дъска',
    bgp_stripes: 'Райета'
  }
};
